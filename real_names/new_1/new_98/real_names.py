class Welcome:
	...
	d:\IT\RT-RK\GIT\gitHubRepo\real_names\new_1\new_98\
	d:\IT\RT-RK\GIT\gitHubRepo\real_names\new_1\new_98\d:\IT\RT-RK\GIT\gitHubRepo\real_names\new_1\new_98\
    """
    def __init__(self):
        self.welcomeWindow = "{caption='' isvisible='d:\IT\RT-RK\GIT\gitHubRepo\real_names\new_1\new_98\' type='org.eclipse.swt.widgets.Shell'}"
        ...
        self.devicePanelProjectHyperlinkLink = "{caption='modifikacije na grani' container=" + self.devicePanelProjectHyperlink + " styletype='text' visible='true'}"
        self.systemPanelProjectHyperlinkLink = "{caption='modifikacije na grani' container=" + self.systemPanelProjectHyperlink + " styletype='text' visible='true'}"
        ...
        self.confirmShell = "{caption='' isvisible='modifikacije na grani' type='org.eclipse.swt.widgets.Shell'}"
