class Welcome:
    ...
    def __init__(self):
        ...
        self.libraryProjectHyperlinkLink = "{caption='Proiect de librarie' pore='dodato da ide na remote' container=" + self.libraryProjectHyperlink + " styletype='text' visible='true'}"
