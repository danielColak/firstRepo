class Welcome:
    ...
    def __init__(self):
        ...
        self.noInstallPackageLabel = "{caption='OVO DOLAZI SA REMOTE' id='noInstalledPackage' styletype='scs-label-package-error scs-label-package-error' visible='true' window= " + self.welcomeWindow + "}"
