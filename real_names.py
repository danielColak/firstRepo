...
class MainShell:
    ...
    def getProgressBar(self):
        ...
        """
        return "{styletype='progress-bar' visible='true' window=" + self.mainWindow + "}"
...
class PopupListView:
    ...
    def getPopupListIthem(self, name):
        """
        Usage:
        PopupListView().getPopupListIthem(name)
        """
        return "{caption='" + name + "' container=" + self.listView + " styletype='cell indexed-cell list-cell' visible='true'}"
...
class LinkProject:
    ...
    def __init__(self, name):
        self.mainShell = "{caption='Link project \\'" + name + "\\' with a system' isvisible='true' type='org.eclipse.swt.widgets.Shell'}"
...
class NewSystemProjectShell:
    ...
    def getVirtualSystemsListView(self):
        """
        Usage:
        NewSystemProjectShell().getVirtualSystemsListView()
        """
        return self.virtualSystemsListView
...
class PanelEditor:
    ...
    def getDotFromConnection(self, root):
        """
        @param root - real name of root

        Usage:
        PanelEditor(panel).getDotFromConnection(root)
        """
        dot = "{container=" + root + " type='javafx.scene.shape.Circle' visible='true'}"
        return dot
...
class WidgetProperties:
    ...
    def getArrowDevice(self, tableViewCell):
        ...
        """
        return "{container={container=" + tableViewCell + " id='Device' styletype='combo-box-base combo-box' visible='true'} id='arrow' styletype='arrow' visible='true'}"
