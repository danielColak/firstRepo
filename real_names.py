class Welcome:
    ...
    def __init__(self):
        ...
        self.libraryProjectHyperlinkLink = "{caption='Ovo je biblioteka projekat' pore='dodato da ide na remote' container=" + self.libraryProjectHyperlink + " styletype='text' visible='true'}"
