class Welcome:
    ...
    def __init__(self):
        ...
        self.libraryProjectHyperlinkLink = "{caption='Proiect de librarie' repo='Am adaugat ceva remote' container=" + self.libraryProjectHyperlink + " styletype='text' visible='true'}"
